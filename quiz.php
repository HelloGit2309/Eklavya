...
else
{
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				echo "<h1 class='Result-heading' align='center'>Result</h1>";
				$_SESSION['qn']=$_SESSION['qn']+1;
				echo "<Table class='result' align=center><tr class=tot><td>Total Question<td> $_SESSION[qn]";
				...
				echo "<h1 style='color:#301B3F;'align=center><a href=review.php> Review Question</a> </h1>";
				unset($_SESSION['qn']);
				unset($_SESSION['sid']);
				unset($_SESSION['tid']);
...
echo "<table width=100%> <tr> <td width=30>&nbsp;<td> <table class='questions-table' border=0>";
$n=$_SESSION['qn']+1;
...
if($_SESSION['qn']<mysqli_num_rows($rs)-1)
echo "<tr><td><input class='btn btn-dark next-question' type=submit name=submit class=next-review value='Next Question'></form>";
else
echo "<tr><td><input type=submit name=submit class='btn btn-success next-question' value='Get Result'></form>";
echo "</table></table>";
include('footer.php');
?>
</body>
