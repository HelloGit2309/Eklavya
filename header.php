	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarNav">
	      <ul class="navbar-nav justify-content-end">
					...
					<li class="nav-item">
						<a style="text-decoration:none;color:#F6F6F6" class="nav-link" href="#">About</a>
					</li>
					<li class="nav-item">
						<a style="text-decoration:none;color:#F6F6F6" class="nav-link" href="#footer">Contact</a>
					</li>
</div>

			 		<div class="d-grid gap-2 d-md-flex justify-content-md-end">
					<a style="text-decoration:none;color:white" class="btn btn-dark btn-lg " href="signup.php" class="button">Register</a>
